...
$mod_strings = array (
  ...
  'LBL_MAP' => '地図',
  'LBL_MODULE_NAME' => '地図',
  'LBL_MODULE_TITLE' => 'マップ: ホーム',
  'LBL_MODULE_ID' => '地図',
  'LBL_LIST_FORM_TITLE' => '地図リスト',
  'LBL_MAP_CUSTOM_MARKER' => 'カスタムマーカー',
  'LBL_MAP_CUSTOM_AREA' => 'カスタムエリア',
  'LBL_HOMEPAGE_TITLE' => '私のマップ リスト',
  'LBL_FLEX_RELATE' => 'Related to (Center):',
  'LBL_MODULE_TYPE' => '表示するモジュールの種類:',
  'LBL_DISTANCE' => 'Distance (Radius):',
  'LBL_UNIT_TYPE' => 'ユニットタイプ:',
  'LBL_MAP_DISPLAY' => 'Map Display',
  'LBL_MAP_LEGEND' => '順序:
',
  'LBL_MAP_USER_GROUPS' => 'グループ一覧:',
  'LBL_MAP_GROUP' => 'グループ',
  'LBL_MAP_TYPE' => 'タイプ',
  'LBL_MAP_ASSIGNED_TO' => 'アサイン先:',
  'LBL_MAP_GET_DIRECTIONS' => 'Get Directions',
  'LBL_MAP_GOOGLE_MAPS_VIEW' => 'Google Maps View',
  'LNK_NEW_MAP' => '新しい地図を追加',
  'LNK_NEW_RECORD' => '新しい地図を追加',
  'LNK_MAP_LIST' => 'List Maps',
  'LBL_MAP_ADDRESS_TEST' => 'ジオコーディングテスト',
  'LBL_MAP_QUICK_RADIUS' => 'Quick Radius Map',
  'LBL_MAP_NULL_GROUP_NAME' => 'なし',
  'LBL_MAP_ADDRESS' => '住所',
  ...
  'LBL_MODULE_HEADING' => 'モジュール',
  'LBL_MODULE_TOTAL_HEADING' => '合計',
  'LBL_MODULE_RESET_HEADING' => 'リセット',
  ...
  'LBL_ADDRESS_CACHE' => 'アドレスキャッシュ',
  'LBL_ADD_TO_TARGET_LIST' => 'Add to Target List',
  'LBL_ADD_TO_TARGET_LIST_PROCESSING' => '処理中...',
  ...
  'LBL_CONFIG_ADDRESS_TYPE_SETTINGS_TITLE' => 'アドレス種類の設定: これはアドレスをジオコーディングする際、使用されるモジュールのアドレス種類を定義します。使用できる値: \'billing\'; \'shipping\'; \'primary\'; \'alt\'; \' flex_relate\'',
  ...
  'LBL_CONFIG_ADDRESS_TYPE_FOR_LEADS' => '潜在顧客の住所の種類',
  ...
  'LBL_CONFIG_GROUP_FIELD_FOR_LEADS' => '潜在顧客のグループフィールド:',
  ...
  'LBL_CONFIG_GEOCODING_API_URL_DESC' => 'The URL of the Google Maps Geocoding API or Proxy',
  ...
  'LBL_JJWG_MAPS_JJWG_AREAS_FROM_JJWG_AREAS_TITLE' => 'エリア',
  'LBL_JJWG_MAPS_JJWG_MARKERS_FROM_JJWG_MARKERS_TITLE' => 'マーカー',
  'LBL_PARENT_ID' => '親会社ID',
  'LBL_JJWP_PARTNERS' => 'JJWP パートナー',
