...
<img src=include/images/suitecrm_login.png style="margin-right: 5px;">
  ...
  'LBL_CREATE_CASES' => 'ケースを作成する',
  'LBL_CREATE_LEADS' => 'リードを作成する',
  'LBL_CREATE_CONTACTS' => '連絡先を作成する',
  'LBL_CREATE_BUGS' => 'バグを作成する',
  'LBL_CREATE_TASKS' => 'タスクを作成する',
  'LBL_CHECK_INLINE' => '正しい',
  'LBL_CLOSE' => '閉じる',
  'LBL_HELP' => 'ヘルプ',
  'LBL_WAIT' => '待つ',
  'LBL_CHECKEMAIL' => 'メールをチェックする',
