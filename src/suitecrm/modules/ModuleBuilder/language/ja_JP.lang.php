...
$mod_strings = array(
    ...
    'help' => array(
        ...
        'listViewEditor' => array(
            'modify' => 'すべてのフィールドは<b>一覧画面</b>に表示させることが可能です。<br><br><b>デフォルト</b>カラムにはデフォルトで一覧画面に表示するフィールドが含まれています。<br/><br/><b>利用可能</b>カラムはカスタムの一覧画面でユーザが詮索する際に選択可能なフィールドが含まれています。<br/><br/><b>非表示</b>カラムはデフォルトカラムや利用可能カラムに追加することが可能なフィールドが含まれています。<br/><br/><!--not_in_theme!--><img src="themes/default/images/SuiteCRMLogic/icon_dependent.png"/>は、計算式によって表示非表示が設定される依存フィールドであることを示しています。<br/>は、計算式によって自動的に値が入力されるフィールドであることを示しています。'
        ,
        ...
        'exportcustom' => array(
            'exportHelp' => 'スタジオで施されたカスタマイズをパッケージとして梱包し、他のSuiteCRMインスタンスに<b>モジュールローダー</b>経由でインストールすることができます。<br><br>まず、<b>パッケージ名</b>を入力してください。また、<b>作成者</b>や<b>詳細</b>情報を入力することも可能です。<br><br>エクスポートしたいモジュールを選択してください。カスタマイズを含むモジュールだけが選択対象として表示されます。<br><br>そして、<b>エクスポート</b>をクリックしてカスタマイズを含む.zipファイルを生成します。',
        ...
        'portalSync' => array(
            'default' => '更新する<b>SuiteCRMポータルのURL</b>を入力し、<b>Go</b>をクリックしてください。<br><br>適切なSuiteCRMユーザ名とパスワードを入力し、<b>同期の開始</b>をクリックしてください。<br><br>カスタマイズされたSuiteCRMポータルの<b>レイアウト</b>と<b>スタイルシート</b>（アップロードされている場合）が指定されたポータルインスタンスに送信されます。',
        ),
        'portalStyle' => array(
