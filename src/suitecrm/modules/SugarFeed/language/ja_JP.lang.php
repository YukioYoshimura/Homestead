...
$mod_strings = array(
    ...
    'CREATED_CONTACT' => 'は、{0} <b>新規</b> 作成した',
    'CREATED_OPPORTUNITY' => 'は、{0} <b>新規</b> 作成した',
    'CREATED_CASE' => 'は、{0} <b>新規</b> 作成した',
    'CREATED_LEAD' => 'は、{0} <b>新規</b> 作成した',
    'FOR' => '金額',
    'CLOSED_CASE' => '{0} <b>クローズ</b>しました。 ',
    'CONVERTED_LEAD' => 'は、{0} <b>コンバート</b>しました。',
    'WON_OPPORTUNITY' => 'は、{0} <b>受注</b>しました。',
    'WITH' => '取引先',
